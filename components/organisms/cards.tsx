...
const Cards: React.FC<{ label: string; count: number; icon: string }> = ({ label, count, icon }) => {
    return (
            ...
            <div className="w-[208px] h-[130px] max-md:w-[90%] px-4 py-4 flex flex-col justify-between dark:bg-gray-900 shadow-soft bg-white rounded-lg dark:border dark:border-gray-700">
